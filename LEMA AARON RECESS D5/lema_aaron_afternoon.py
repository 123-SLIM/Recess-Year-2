...
#  Using curly braces
dictionary1 = {'Aaron': 'tvalue', 'Balaba': 'bvalue', 'Charlse': 'cvalue'}
...
if 'Francis' in dictionary1:
    print("Key exists")
else:
    print("Key does not exist")

# Using the not in operator
dictionary2 = {'Aaron': 'tvalue', 'Balaba': 'bvalue', 'Charlse': 'cvalue'}

if 'Francis' not in dictionary2:
    print("Key does not exist")
else:
    print("Key exists")
